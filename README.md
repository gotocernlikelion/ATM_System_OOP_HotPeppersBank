...
1. (REQ1.1) An ATM has a 6-digit serial number that can be uniquely identified among all ATMs (e.g., 315785).   
...
2. (REQ1.2) An ATM is set to one of the following types: (1) Single Bank ATM, (2) Multi-Bank ATM.   
...
3. (REQ1.3) An ATM may support either unilingual or bilingual languages.   
...
4.  (REQ1.4) A Bank deposits a certain amount of cashes to an ATM to serve users.   
   ![][image6]  
   

	ATM의 초기설정에서 각 ATM의 1,000원, 5,000원, 10,000원, 50,000원 지폐 수를 설정할 수 있다. 

5. (REQ1.5) A Bank can open an Account for a user with the necessary information to perform bank services.   
   - (e.g.) Bank name (e.g, Kakao, Shinhan), User name, Account number (12-digit), Available funds, Transaction histories.   
     
   ![][image7]  

6. (REQ1.6) A user may have multiple Accounts in a Bank.  
     
   ![][image8]  
   위 사진은 dy1 유저가 toss 은행 계좌를 1개 만드는 것을 보여준다.  
     
7. `(REQ1.7) A user may have Accounts in multiple Banks`  
   `![][image9]`  
...
8. `(REQ1.8) Each ATM have several types of transaction fees, and paid as follows: - Deposit fee for non-primary banks: KRW 2,000; the fee is paid by inserting additional cash. - Deposit fee for primary banks: KRW 1,000; the fee is paid by inserting additional cash.`   
