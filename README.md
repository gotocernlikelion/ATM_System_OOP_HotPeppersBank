...
2. [Requirement Implementation](#requirement-implementation)  
   - [2.1 System Setup](#21-system-setup)  
     ...
     - [REQ 1.4: Cash Deposit Setup for ATMs](#req-14-cash-deposit-setup-for-atms)  
     - [REQ 1.5: Account Creation for Users](#req-15-account-creation-for-users)  
     - [REQ 1.6: Multiple Accounts in a Bank](#req-16-multiple-accounts-in-a-bank)  
     - [REQ 1.7: Accounts in Multiple Banks](#req-17-accounts-in-multiple-banks)  
     - [REQ 1.8: Transaction Fees](#req-18-transaction-fees)  
     - [REQ 1.9: Admin Access for Transaction History](#req-19-admin-access-for-transaction-history)  
     - [REQ 1.10: Supported Cash and Check Types](#req-110-supported-cash-and-check-types)  
     - [REQ 1.11: Initialization of Accounts and ATMs](#req-111-initialization-of-accounts-and-atms)  
   - [2.2 ATM Session](#22-atm-session)  
     - [REQ 2.1: Session Start](#req-21-session-start)  
     - [REQ 2.2: Session Termination](#req-22-session-termination)  
     - [REQ 2.3: Transaction Summary on Session End](#req-23-transaction-summary-on-session-end)  
     - [REQ 2.4: Unique Transaction Identifiers](#req-24-unique-transaction-identifiers)  
   - [2.3 User Authorization](#23-user-authorization)  
     - [REQ 3.1: Valid Card Check](#req-31-valid-card-check)  
     - [REQ 3.2: Error Handling for Invalid Cards](#req-32-error-handling-for-invalid-cards)  
     - [REQ 3.3: Password Authentication](#req-33-password-authentication)  
     - [REQ 3.4: Handling Incorrect Passwords](#req-34-handling-incorrect-passwords)  
     - [REQ 3.5: Session Termination on Multiple Incorrect Attempts](#req-35-session-termination-on-multiple-incorrect-attempts)  
   - [2.4 Deposit](#24-deposit)  
     - [REQ 4.1: Cash and Check Deposits](#req-41-cash-and-check-deposits)  
     - [REQ 4.2: Handling Excess Deposit Amounts](#req-42-handling-excess-deposit-amounts)  
     - [REQ 4.3: Reflecting Deposits in Bank Accounts](#req-43-reflecting-deposits-in-bank-accounts)  
     - [REQ 4.4: Deposit Fees](#req-44-deposit-fees)  
     - [REQ 4.5: Increasing ATM Cash Availability](#req-45-increasing-atm-cash-availability)  
     - [REQ 4.6: Check Deposits and ATM Cash Availability](#req-46-check-deposits-and-atm-cash-availability)  
   - [2.5 Withdrawal](#25-withdrawal)  
     - [REQ 5.1: Fund Withdrawal and Denomination Dispensing](#req-51-fund-withdrawal-and-denomination-dispensing)  
     - [REQ 5.2: Handling Insufficient Funds or Cash](#req-52-handling-insufficient-funds-or-cash)  
     - [REQ 5.3: Reflecting Withdrawals in Bank Accounts](#req-53-reflecting-withdrawals-in-bank-accounts)  
     - [REQ 5.4: Withdrawal Fees](#req-54-withdrawal-fees)  
     - [REQ 5.5: Decreasing ATM Cash Availability](#req-55-decreasing-atm-cash-availability)  
     - [REQ 5.6: Withdrawal Limits Per Session](#req-56-withdrawal-limits-per-session)  
     - [REQ 5.7: Maximum Withdrawal Amount Per Transaction](#req-57-maximum-withdrawal-amount-per-transaction)  
   - [2.6 Transfer](#26-transfer)  
     - [REQ 6.1: Transfer Type Selection](#req-61-transfer-type-selection)  
     - [REQ 6.2: Destination Account Entry](#req-62-destination-account-entry)  
     - [REQ 6.3: Cash Transfer Process](#req-63-cash-transfer-process)  
     - [REQ 6.4: Account Transfer Process](#req-64-account-transfer-process)  
     - [REQ 6.5: Transfer Fees](#req-65-transfer-fees)  
     - [REQ 6.6: Increasing ATM Cash Availability with Transfers](#req-66-increasing-atm-cash-availability-with-transfers)  
     - [REQ 6.7: Reflecting Transfers in Bank Accounts](#req-67-reflecting-transfers-in-bank-accounts)  
   - [2.7 Transaction History](#27-transaction-history)  
     - [REQ 7.1: Admin Access for Transaction History](#req-71-admin-access-for-transaction-history)  
     - [REQ 7.2: Displaying Transaction Details](#req-72-displaying-transaction-details)  
     - [REQ 7.3: Exporting Transaction History](#req-73-exporting-transaction-history)  
   - [2.8 Multi-language Support](#28-multi-language-support)  
     - [REQ 8.1: Language Selection for Bilingual ATMs](#req-81-language-selection-for-bilingual-atms)  
     - [REQ 8.2: Displaying Menus in Chosen Language](#req-82-displaying-menus-in-chosen-language)  
   - [2.9 Exception Handling](#29-exception-handling)  
     - [REQ 9.1: Handling Various Error Scenarios](#req-91-handling-various-error-scenarios)  
   - [2.10 Display of Account/ATM Snapshot](#210-display-of-accountatm-snapshot)  
     - [REQ 10.1: Snapshot Display Using Console Commands](#req-101-snapshot-display-using-console-commands)  
...
#### (REQ4.4) Some deposit fee may be charged (See REQ in System Setup) - In case of a check deposit, a fee must be served as cash. - The deposit amount and the fee must be entered separately, with one entry for the deposit and another for the fee.
...
#### (REQ5.6) The maximum number of withdrawals per each session is 3. - If a user wants to withdraw four times, it needs to end the current session after withdrawing three times and restart another session for one more withdrawal.  
